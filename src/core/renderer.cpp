...
void Renderer::update() {
    ...
    // TESTING - Move up an down - testing translation of a parent node
    ...
    // TODO check code examples, I don't think this is needed
    bgfx::touch(0);
...
void Renderer::cameraViewUpdate() {
...
void Renderer::findNodes(const std::unique_ptr<Node>& node) {
    // only perform the dynamic_cast in the setup function, not each frame
